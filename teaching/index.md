  ...
  <div class="course-card current">
    <div class="course-header">
      <div class="course-meta">
        ...
        <span class="level">MSc students</span>
      </div>
    </div>
    ...
    <div class="course-collaborators">
      <h4>Teaching Team</h4>
      <ul>
        <li><strong>Dr. Imanol Schlag</strong> - Course Lecturer</li>
        <li><strong>Dr. Arnout Devos</strong> - Course Lecturer</li>
        <li><strong>Philipp Gerstner</strong> - Student Assistant</li>
        <li><strong>Junling Wang</strong> - Teaching Assistant</li>
      </ul>
    </div>
    ...
    <div class="course-links">
      ...
      <ul>
        <li><a href="https://www.vvz.ethz.ch/Vorlesungsverzeichnis/lerneinheit.view?semkez=2025W&ansicht=ALLE&lerneinheitId=192058&lang=en" class="external-link">Official Course Listing</a> (ETH VVZ)</li>
        <li><a href="https://moodle-app2.let.ethz.ch/course/view.php?id=26529" class="external-link">Course Page</a> (Moodle)</li>
    ...
    <div class="course-info">
      <p class="course-schedule">Schedule: Wednesdays 10:15-12:00 | Location: HG E5 | ~125 participants</p>
    </div>
  </div>
